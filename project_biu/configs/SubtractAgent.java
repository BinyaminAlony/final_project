...
/**
 * The SubtractAgent class represents an agent in the directed calculational graph.
 * when a message is recieved, it subtracts the values of the input topics (first two topics in the argument lists), 
...
public class SubtractAgent implements Agent{
	 ...
	 */
	public SubtractAgent(ArrayList<String> inTopics, ArrayList<String> outTopics) {
